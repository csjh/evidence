...
<aside class="sidebar" class:open>
    <div class="sticky">
                ...
                {#if item.href !== '/'}
					{#if dev && item.nameError}
						<a href={item.href} sveltekit:prefetch on:click={() => open = !open} style="">
							<div class=name-error class:selected="{"/"+$page.url.href.split('/')[1] === item.href}">
					...
					{:else}
						<a href={item.href} sveltekit:prefetch on:click={() => open = !open} style="">
							<div class:selected="{"/"+$page.url.href.split('/')[1] === item.hrefUri}">
								{item.label}
							</div>
						</a>
					{/if}
        ...
        <div class="nav-footer">
			<a href='/settings' class="settings-link" class:selected="{$page.url.href === '/settings'}">
